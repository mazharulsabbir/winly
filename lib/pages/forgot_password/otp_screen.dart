      ...
      child: Form(
        ...
        child: Column(
          children: <Widget>[
            ...
            TextFormField(
              decoration:
                  TextFieldHelpers.decoration(label: 'New Password').copyWith(
                suffixIcon: IconButton(
                  onPressed: () {
                    setState(() => isHeaden = !isHeaden);
                  },
                  icon: Icon(
                    isHeaden ? Icons.visibility : Icons.visibility_off,
                  ),
                ),
              ),
            ...
            ElevatedButton(
                onPressed: () async {
                  debugPrint(
                    'Code: $code and oassword: ${passwordController.text}',
                  );
                      ...
                      await authController
                        ...
                        if (value) {
                          ...
                          snack(
                            title: 'Oops!',
                            desc:
                                "Password Reset Failed. Please check your password reset code code.",
                            icon: const Icon(Icons.done),
                          );
                        }
                      });
